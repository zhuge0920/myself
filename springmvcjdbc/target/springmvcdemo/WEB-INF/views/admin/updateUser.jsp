...
<script type="text/javascript">
    ...
    $(function () {
        $("#commit").click(function (id) {
            var user_name=$("#name").val();
            var user_age=$("#age").val();
            var user_id=$("#id").val();
            $.ajax({
                url: "/admin/users/updateP/",//后台url
                data:JSON.stringify({"name":user_name,"age":parseInt(user_age),"id":user_id})+"&_method=PUT",
                type:"PUT",                 //类型，POST或者GET等
